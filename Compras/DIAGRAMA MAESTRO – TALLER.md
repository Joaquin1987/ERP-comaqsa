...
flowchart TD
    ...
    AUT_N["Autorización por montos<br/><br/>
    ...
    CC_COT_COMP["Completar cotizaciones<br/>o justificar excepción"]
    ...
    P_C -->|"Crédito"| CC_ENT
    CC_ENT --> CC_REC --> CC_PREC --> CC_COT_COMP --> CC_AUT --> CC_OCN --> CC_FAC --> CC_PROG
    ...
    CT_COT_COMP["Completar cotizaciones<br/>o justificar excepción"]
    ...
    CT_EXIGE --> CT_PAGO_ANT --> CT_ENT --> CT_REC --> CT_PREC --> CT_COT_COMP --> CT_AUT --> CT_OCN --> CT_PAGO_COMP --> CT_FAC

    %% =====================================
    %% NOTA: QUÉ IMPLICA MARCAR COMO CRÍTICA EN TALLER
    %% =====================================
    ...
    En crítico, las cotizaciones iniciales pueden ser 0 o 1,<br/>
    pero antes de autorizar retroactivamente se deben<br/>
    completar o justificar."] -.-> COMP_CRIT
